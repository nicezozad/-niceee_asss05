<script>
  // รับ props จาก parent เช่น farmerId, category, title ฯลฯ
  export let category;
  export let title;
  export let lastUpdated = '';
  export let note = '';
  export let ctaLabel = 'ดูรายละเอียด';
  export let imageAlt = '';
  export let farmerId;
</script>
...
<div class="card">
  ...
  <div class="content">
    ...
    <!-- ปุ่มลิงก์ไปหน้าหมวดในเกษตรกรคนนั้น -->
    <a class="btn" href={`${window.location.pathname}/${category.toLowerCase()}`}>{ctaLabel}</a>
  </div>
</div>
